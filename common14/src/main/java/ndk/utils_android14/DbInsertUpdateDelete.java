...
public class DbInsertUpdateDelete extends AsyncTask<Void, Void, String[]> {
    ...
    public DbInsertUpdateDelete(String URL, ArrayList<NameValuePair> parameters, Context context, View progressBar, View form, String TAG, HttpApiSelectTask14.AsyncResponseJSONObject asyncResponseJsonObject) {
    ...
    public DbInsertUpdateDelete(String URL, ArrayList<NameValuePair> parameters, Context context, View progressBar, View form, String TAG, HttpApiSelectTask14.AsyncResponseJSONArray asyncResponseJsonArray) {
    ...
    public DbInsertUpdateDelete(String URL, ArrayList<NameValuePair> parameters, Context context, View progressBar, View form, String TAG, HttpApiSelectTask14.AsyncResponse asyncResponse) {
